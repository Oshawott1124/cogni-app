...
export interface IKeyboardShortcutHelper {
  ...
  toggleOverlayMode: () => void // New: Discord-like overlay toggle (now edit mode)
  exitEditMode: () => void // New: Exit edit mode with ESC
  isVisible: () => boolean
...
export class KeyboardShortcutHelper {
  ...
  public registerGlobalShortcuts(): void {
    ...
    // Discord-like overlay toggle with Shift+Tab (now toggles edit mode)
    globalShortcut.register('Shift+Tab', () => {
      console.log('toggleEditMode')
      this.deps.toggleOverlayMode()
    })
    // ESC to exit edit mode
    globalShortcut.register('Escape', () => {
      console.log('exitEditMode')
      this.deps.exitEditMode()
    })
